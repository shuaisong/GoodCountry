...
public class HotelDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initData() {
        ...
        HotelBean.JsonHotBean good = (HotelBean.JsonHotBean) intent.getSerializableExtra("good");
        SpannableStringBuilder span = new SpannableStringBuilder("酒店介绍");
        span.setSpan(new ForegroundColorSpan(Color.TRANSPARENT), 0, 2,
                Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
        mDescription.setText(span);
        String hotelDesc = good.getHotelDesc();
        String[] split = hotelDesc.split("\\|");

        List<String> imgs = new ArrayList<>(split.length);
        for (String s :
                split) {
            imgs.add(Constant.IMG_URL + s);
        }
        setBanner(mGoodBanner, null, imgs);
        mGoodPrice.setText(String.format("$%s/天", good.getHotelPrice()));
        for (int j = 0; j < 4; j++) {
            ShopCommentBean commentBean = new ShopCommentBean();
            commentBean.setHead(
                    "https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1548319382466&di=ebd7e21b73c2e5bf1f36133ace81f048&imgtype=0&src=http%3A%2F%2Fs7.sinaimg.cn%2Fmiddle%2F4b916806x7525f6e44bc6%26690"
            );
            commentBean.setContent("文章描述信息文章描述信息文章描述信息文章描述信息文章描述信息文章描述信息文章描述信息文章描述信息");
            commentBean.setDate("xxxx-xx-xx xx:xx:xx");
            commentBean.setName("里斯");
            commentBean.setImgs(new ArrayList<>(Arrays.asList(Constant.proxy_imgs)));
    ...
    protected void initViews() {
        ...
        mAdapter = new BaseQuickAdapter<ShopCommentBean, BaseViewHolder>(R.layout.good_comment_item, mCommentBeans) {
            ...
            protected void convert(BaseViewHolder helper, final ShopCommentBean item) {
                ...
                Glide.with(HotelDetailActivity.this).asBitmap().error(R.mipmap.error).
                        placeholder(R.mipmap.img_shoppingmall_default_jd).load(item.getHead()).apply(options).into(mHead);

                img_recycler.setLayoutManager(new GridLayoutManager(HotelDetailActivity.this, 3));
                ...
                BaseQuickAdapter<String, BaseViewHolder> adapter = new BaseQuickAdapter<String, BaseViewHolder>(R.layout.img_item, item.getImgs()) {
                    ...
                    protected void convert(final BaseViewHolder helper, String item) {
                        Glide.with(HotelDetailActivity.this).asBitmap().load(item)
                ...
                adapter.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                        ...
                        GPreviewBuilder.from(HotelDetailActivity.this)
                    ...
                    mTimePickerView1 = new TimePickerBuilder(this, new OnTimeSelectListener() {
                        ...
                        public void onTimeSelect(Date date, View v) {
                            if (mTimePickerView2 == null)
                                mTimePickerView2 = new TimePickerBuilder(HotelDetailActivity.this, new OnTimeSelectListener() {
                                    @Override
                                    public void onTimeSelect(Date date, View v) {
                    ...
                    mNum.addTextChangedListener(new TextWatcher() {
                        ...
                        public void onTextChanged(CharSequence s, int start, int before, int count) {
                            if (!"".equals(s.toString()) && Integer.valueOf(s.toString()) < 1) {
                                ...
                                ToastUtil.showToast(HotelDetailActivity.this, "请输入大于0的数字");
                            }
                        }
