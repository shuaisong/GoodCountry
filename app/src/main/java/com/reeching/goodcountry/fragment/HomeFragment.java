...
import com.reeching.goodcountry.view.ViewPagerForScrollView;
 ...
 * Date：2019/1/23
 */
public class HomeFragment extends BaseAddFragment implements HomeContact.View {
    @Inject
    ...
    ViewPagerForScrollView mHomeVp;
