...
public class ArticleCollectionFragment extends BasePageFragment implements CommunityContact.View {
    @Inject
    ...
    private ArrayList<ArticleBean1.DataBean.AritleArrBean> mArticleBeans;
    ...
    protected void initData() {
        ...
        mPresenter.getArticle(wzWt, pageNo,
                type, null, null, mOpenId);
    }
...
//                LogUtil.d(item.getTxlj());
                Glide.with(Objects.requireNonNull(ArticleCollectionFragment.this.getActivity())).asBitmap().load(Constant.IMG_URL + item.getTxlj()).apply(options).into(head);
                ...
                helper.setNestView(R.id.integral);
                helper.setNestView(R.id.fabulous);
                helper.setNestView(R.id.collection);
        ...
        mAdapter.setOnLoadMoreListener(new BaseQuickAdapter.RequestLoadMoreListener() {
            ...
            public void onLoadMoreRequested() {
                ...
                mPresenter.getArticle(wzWt, pageNo, type, null,
                        null, mOpenId);
                ++pageNo;
            }
        }, mRecyclerView);
        ...
        mRecyclerView.addItemDecoration(new SpaceItemDecoration(5), getActivity().getResources().getColor(R.color.divider));
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                mArticleBeans.clear();
                pageNo = 0;
                mPresenter.getArticle(wzWt, pageNo, type, null, null
                        , mOpenId);
            }
        });
    }
    ...
    protected int getLayout() {
        return R.layout.fragment_articl_collection;
    }


    @OnClick({R.id.title, R.id.collection, R.id.line})
                ...
                if (mTypePicker == null) {
                    mTypePicker = new OptionsPickerBuilder(getActivity(), new OnOptionsSelectListener() {
                        ...
                        public void onOptionsSelect(int options1, int options2, int options3, View v) {
                            mCollection.setText(Constant.ARTICLE_COLLECTION[options1]);
                        }
                    }).setCancelColor(R.color.divider).setSubmitColor(R.color.green).build();
                    mTypePicker.setNPicker(Arrays.asList(Constant.ARTICLE_COLLECTION), null, null);
                }
                mTypePicker.show();
                break;
            case R.id.line:
